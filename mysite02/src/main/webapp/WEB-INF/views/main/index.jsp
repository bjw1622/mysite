	...
	<div id="container">
		<div id="header">
			...
			<ul>
				...
				<li><a href="<%=request.getContextPath() %>/user?a=updatefrom">회원정보수정</a><li>
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" src="<%=request.getContextPath() %>/assets/images/loopy.jpg">
					<h2>안녕하세요. 둘리의  mysite에 오신 것을 환영합니다.</h2>
					<p>
